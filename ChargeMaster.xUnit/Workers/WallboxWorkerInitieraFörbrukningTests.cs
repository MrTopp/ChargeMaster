...
public class WallboxWorkerInitieraFörbrukningTests
{
    ...
    public async Task InitieraFörbrukningAsync_WithReadings_SetsPropertiesCorrectly()
    {
        ...
        var readings = new List<WallboxMeterReading>
        {
            ...
            new()
            {
                Id = 1, ReadAt = new DateTime(2024, 6, 15, 12, 45, 0), AccEnergy = 1000,
                RawJson = ""
            },
            // 2024-06-15 13:30
            new()
            {
                Id = 2, ReadAt = new DateTime(2024, 6, 15, 13, 30, 0), AccEnergy = 1500,
                RawJson = ""
            },
            // 2024-06-15 14:15
            new()
            {
                Id = 3, ReadAt = new DateTime(2024, 6, 15, 14, 15, 0), AccEnergy = 2000,
                RawJson = ""
            },
            // 2024-06-15 14:25
            new()
            {
                Id = 4, ReadAt = new DateTime(2024, 6, 15, 14, 25, 0), AccEnergy = 2200,
                RawJson = ""
            }
        };
    ...
    public async Task InitieraFörbrukningAsync_CalculatesFörbrukningFöregåendeTimme()
    {
        ...
        var readings = new List<WallboxMeterReading>
        {
            ...
            new()
            {
                Id = 1, ReadAt = new DateTime(2024, 6, 15, 13, 0, 0), AccEnergy = 1000, RawJson = ""
            },
            // 2024-06-15 13:00 (slutet på föregående timme)
            new()
            {
                Id = 2, ReadAt = new DateTime(2024, 6, 15, 14, 0, 0), AccEnergy = 1500, RawJson = ""
            },
            // 2024-06-15 14:20 (innevarande timme)
            new()
            {
                Id = 3, ReadAt = new DateTime(2024, 6, 15, 14, 20, 0), AccEnergy = 1800,
                RawJson = ""
            },
            // 2024-06-15 14:30 (innevarande timme, senare än föregående)
            new()
            {
                Id = 4, ReadAt = new DateTime(2024, 6, 15, 14, 30, 0), AccEnergy = 2000,
                RawJson = ""
            }
        };
    ...
    public async Task InitieraFörbrukningAsync_WithSingleReading_HandlesGracefully()
    {
        ...
        var readings = new List<WallboxMeterReading>
        {
            new()
            {
                Id = 1, ReadAt = new DateTime(2024, 6, 15, 14, 30, 0), AccEnergy = 1000,
                RawJson = ""
            }
        };
    ...
    public async Task InitieraFörbrukningAsync_WithReadingsSpanningMultipleDays_WorksCorrectly()
    {
        ...
        var readings = new List<WallboxMeterReading>
        {
            new()
            {
                Id = 1, ReadAt = new DateTime(2024, 6, 14, 23, 0, 0), AccEnergy = 5000, RawJson = ""
            },
            new()
            {
                Id = 2, ReadAt = new DateTime(2024, 6, 15, 0, 0, 0), AccEnergy = 5200, RawJson = ""
            },
            new()
            {
                Id = 3, ReadAt = new DateTime(2024, 6, 15, 1, 0, 0), AccEnergy = 5400, RawJson = ""
            },
            new()
            {
                Id = 4, ReadAt = new DateTime(2024, 6, 15, 2, 30, 0), AccEnergy = 5600, RawJson = ""
            }
        };
    ...
    [Fact(Skip = "Only for interactive testing")]
    public async Task
        InitieraFörbrukningAsync_CancellationRequested_ThrowsOperationCanceledException()
    {
        // Arrange
        var readings = new List<WallboxMeterReading>
        {
